...
def _trace_to_dict(trace: ProfilerTrace) -> dict[str, Any]:
    ...
    payload: dict[str, Any] = {
        ...
        "num_key_value_heads": int(getattr(trace, "num_key_value_heads", 0)),
        "head_dim": int(getattr(trace, "head_dim", 0)),
        "sliding_window": int(getattr(trace, "sliding_window", 0)),
        "num_experts_per_tok": int(getattr(trace, "num_experts_per_tok", 0)),
        "moe_intermediate_size": int(getattr(trace, "moe_intermediate_size", 0)),
