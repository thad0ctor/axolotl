...
- **Cross-world Mode C full optimizer-state resume requires sidecar metadata.**
  Qwen3.5-4B full-FT packed seq=1024 and seq=2048 validate 4-rank save →
  online 2-rank resume on 3090-class hardware. Older persistent GPU optimizer
  checkpoints without `gpu_optim_rank_*.pt.meta.json` fail closed for
  cross-world resume.
